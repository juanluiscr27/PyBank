...
class GUI:
    ...
    def search(cls):
        ...
        customers_results.column("customer_full_name", anchor="center", width=200)
        ...
        accounts_results.column("customer_full_name", anchor="center", width=200)
        ...
        accounts_results.column("customer_email", anchor="center", width=200)
    ...
    def view_customer(cls):
        ...
        customer_first_name_text = ttk.Label(area, text="Ninja")
        ...
        customer_last_name_text = ttk.Label(area, text="Gaiden")
        ...
        customer_address_text = ttk.Label(area, text="101 Weston")
        ...
        customer_phone_text = ttk.Label(area, text="1234567890")
        customer_phone_text.grid(column=20, row=2, columnspan=5)
        customer_email_label = ttk.Label(area, text="Email")
        customer_email_label.grid(column=25, row=1, columnspan=5)
        customer_email_text = ttk.Label(area, text="ryu@hotmail.com")
        customer_email_text.grid(column=25, row=2, columnspan=5)
    ...
    def new_customer(cls):
        def action_confirm():
            tk.messagebox.showinfo('PyBank', 'Customer created')
            area.destroy()
            cls.view_customer()
        def action_cancel():
            area.destroy()
    ...
    def update_customer(cls):
        def action_confirm():
            tk.messagebox.showinfo('PyBank', 'Customer updated')
            area.destroy()
            cls.view_customer()
        def action_cancel():
            area.destroy()
        ...
        customer_pin_text = ttk.Entry(area, width=10, show='*', textvariable=customer_pin)
        customer_pin_text.grid(column=15, row=7, columnspan=20)
        customer_first_name_text.insert(0, 'Ninja')
        customer_last_name_text.insert(0, 'Gaiden')
        customer_address_text.insert(0, '101 Weston')
        customer_phone_text.insert(0, '1234567890')
        customer_pin_text.insert(0, '1234')
        confirm_button = ttk.Button(area, width=20, text="Confirm", command=action_confirm)
        confirm_button.grid(column=40, row=1, columnspan=8)
        cancel_button = ttk.Button(area, width=20, text="Cancel", command=action_cancel)
        cancel_button.grid(column=40, row=2, columnspan=8)
    ...
    def view_account(cls):
        ...
        account_balance_text = ttk.Label(area, text="$1000")
        ...
        transferred_text = ttk.Label(area, text="$300")
        ...
        transfers_text = ttk.Label(area, text="2")
        ...
        account_movements.insert(parent='', index='end', values=('01-JAN-2022', 'Deposit', '153954873', '459201287', '$15'))
        account_movements.insert(parent='', index='end', values=('04-JUL-2022', 'Transfer own', '950247366', '995014108', '$200'))
        account_movements.insert(parent='', index='end', values=('02-AUG-2022', 'Withdrawal', '288840236', '332017599', '$150'))
    ...
    def open_account(cls):
        def action_confirm():
            tk.messagebox.showinfo('PyBank', 'Account opened')
            area.destroy()
            cls.view_account()
        def action_cancel():
            area.destroy()
