...
class GUI:
    ...
    def search(cls):
        ...
        customers_results.insert(parent='', index='end', values=('1', 'Nancy Sallings', '4291 Derek Road', '4168878442', 'nsallings0@prnewswire.com'))
        ...
        accounts_results.insert(parent='', index='end', values=('', '', '', '', '', ''))
    ...
    def view_customer(cls):
        ...
        customer_accounts.insert(parent='', index='end', values=('109970001', 'Checking', '$100', '$0', '0'))
        accounts_results_button = ttk.Button(area, width=20, text="View account", command=action_account)
    ...
    def update_customer(cls):
        ...
        customer_pin_text = ttk.Entry(area, width=10, show='*', textvariable=customer_pin)
        customer_pin_text.grid(column=15, row=7, columnspan=20)
        customer_first_name_text.insert(0, 'Nancy')
        customer_last_name_text.insert(0, 'Sallings')
        customer_address_text.insert(0, '4291 Derek Road')
        customer_phone_text.insert(0, '4168878442')
        customer_pin_text.insert(0, '2985')
        confirm_button = ttk.Button(area, width=20, text="Confirm", command=action_confirm)
        confirm_button.grid(column=40, row=1, columnspan=8)
        cancel_button = ttk.Button(area, width=20, text="Cancel", command=action_cancel)
        cancel_button.grid(column=40, row=2, columnspan=8)
    ...
    def withdrawal(cls):
        ...
        pin = tk.StringVar()
        pin_text = ttk.Entry(area, width=10, textvariable=pin)
